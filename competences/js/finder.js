...
function initializeJamlTemplates()
	...
	*/
	Jaml.register('result', function(data){
		...
		var thisID = data.mdPath.toString().split("/").pop().split(".")[0];
		   ...
		   header(
		          ...
		          section(p({cls:'item-intro-desc'}, data.thisDescription),
		                  aside({cls:'clearfix'},
		                        ...
		                        div({cls:'floatright'},
		                            div({cls:'line alignright'}, a({href:"item.html?id="+thisID,cls:'moreinfo'}, "More Info")))))))
